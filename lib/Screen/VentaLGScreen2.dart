...
import 'package:venta/Screen/VentaLGScreen3.dart';

class Ventalgscreen2 extends StatelessWidget {
  const Ventalgscreen2({super.key});
          ...
          Center(
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("lib/Asset/İllustrasiya 2.png"),
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(onTap: (){
                Get.to(Ventalgscreen3(),transition: Transition.rightToLeft,
                duration: Duration(milliseconds: 500));
              }, child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
