...
import 'package:venta/Screen/VentaLGScreen2.dart';

class Ventalgscreen1 extends StatelessWidget {
  const Ventalgscreen1({super.key});
          ...
          Center(
              ...
              Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: AssetImage("lib/Asset/İllustrasiya.png"),
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
              ...
              Text(
                "Bizimlə birlikdə sevdiyin sahədə dərin \nbiliklər qazanaraq \nkaryerana güclü bir addım at.",
              ...
              GestureDetector(onTap: (){
                Get.to(Ventalgscreen2(),transition: Transition.fadeIn,
                duration: Duration(milliseconds: 500));
              }, child: Row(
